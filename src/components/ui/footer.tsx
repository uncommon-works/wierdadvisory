...
export default function Footer() {
  return (
    <footer className="pb-[3rem] md:py-[2.5rem]">
      <div className="w-full mx-auto flex flex-col-reverse md:flex-row justify-between text-sm font-medium text-gray-400 px-[3rem] gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 ">
          ...
          <Link href="https://piecemakr.com" className="text-black md:text-gray-400 hover:font-bold transition-all duration-500 hover:text-gray-500 flex items-center pt-8 md:pt-0 mt-6 md:mt-0 border-t-[1px] md:border-t-0 border-gray-200">
            Credits
          </Link>
        </div>
      </div>
