  ...
  return (
    <>
      ...
      <nav className="absolute top-0 z-50 w-full py-[2.5rem] md:py-[2.5rem] flex flex-row items-center justify-between md:bg-transparent md:shadow-none">
        ...
        <div ref={rightBlockRef} className="hidden sm:block fixed top-[2.5rem] right-[3rem] -translate-y-[100px] text-blue-950 z-[80] cursor-pointer">
          <MagneticButton>
            <div onClick={handleOpenSheet} className="flex flex-row gap-2 items-center">
