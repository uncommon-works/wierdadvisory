...
export default function AboutLayout() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Handle desktop emoji animations
  ...
  useEffect(() => {
    ...
    const emojis = Array.from(svgRef.current?.querySelectorAll(".el-desktop") ?? []) as SVGGElement[]
  ...
  return (
    <section ref={sectionRef} className="relative h-auto md:h-[100vh] bg-red-200 text-red-950">
      <div className="sticky top-0 flex flex-col sm:items-center justify-center min-h-screen w-full overflow-hidden px-8">
        <div className="max-w-2xl mx-auto flex flex-col items-start text-left">
          ...
          <div ref={textRef} className="flex flex-col items-start text-lg md:text-xl max-w-xl mt-12">
            <p className="mb-8 text-lg">
              Most strategic problems persist because something&apos;s blocking clear thinking—whether it&apos;s
              outdated assumptions, organizational habits, or past approaches that didn&apos;t work. We help teams cut
        ...
        {/* Large screen emoji */}
        <div
          className={`${notoEmoji.className} hidden sm:block font-noto font-bold text-red-900 relative mx-auto w-screen min-h-[30vh]`}
        >
