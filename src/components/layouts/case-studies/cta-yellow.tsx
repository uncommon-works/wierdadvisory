...
export default function CtaLayout() {
  ...
  return (
    <div ref={ctaSection} className={`${notoEmoji.variable} text-yellow-500 antialiased w-full py-[10rem] flex flex-col items-center justify-center`}> 
      ...
      <div className="flex flex-col md:flex-row gap-4 pt-12 ">
        ...
        <MagneticWrapper asChild>
          <Button asChild variant="yellow" size="lg" className="">
        ...
        <MagneticWrapper >
          <Button onClick={ handleOpenSheet } variant="outlineYellow" size="lg" >
            <p>
              Contact Us
            </p>
          </Button>
