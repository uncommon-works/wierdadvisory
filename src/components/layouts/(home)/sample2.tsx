...
export default function CraftsmanshipSection() {
  ...
  return (
    <section ref={sectionRef} className="relative bg-[#051241]  z-10 py-[10rem]">
      <div className="flex flex-col items-center justify-center w-full overflow-hidden px-4">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          <h2
            ref={headingRef}
            className="text-3xl md:text-4xl text-blue-50 font-regular leading-[1.17] mb-8"
          >
            {words.map((word, i) => (
          ...
          <p ref={textRef} className="text-lg md:text-xl text-blue-200 max-w-3xl mb-12">
            Although we&apos;re based in Toronto, Canada, we are strong disciples of the future of work and service clients around the world.​
          </p>
